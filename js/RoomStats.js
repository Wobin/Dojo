...
(function (RoomStats) {
    // Halls
    var ClanHall = new Elements.RoomTemplate(1, "Clan Hall", "img/Clan Hall.png", 60, 140, [
        new Elements.Door(1, 0, -70),
        new Elements.Door(2, 0, 70)
    ]);
    var GreatHall = ClanHall.Copy(2, "Great Hall", "img/Great Hall.png");

    var GreaterHall = new Elements.RoomTemplate(3, "Greater Hall", "img/Greater Hall.png", 140, 160, [
        new Elements.Door(1, 0, -80),
    ...
    var Reactor = new Elements.RoomTemplate(1005, "Reactor", "img/Reactor.png", 60, 65, [new Elements.Door(1, 30, 65)]);

    var Barracks = new Elements.RoomTemplate(1006, "Barracks", "img/Barracks.png", 65, 55, [new Elements.Door(1, 32, 55)]);
