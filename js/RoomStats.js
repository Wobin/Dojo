...
(function (RoomStats) {
    // Halls
    var ClanHall = new Elements.RoomTemplate(1, "Clan Hall", "img/Clan Hall.png", 140, 60, [
        new Elements.Door(1, 30, 140),
        new Elements.Door(2, 30, 0)
    ]);
    var GreatHall = ClanHall.Copy(2, "Great Hall", "img/Great Hall.png");

    var GreaterHall = new Elements.RoomTemplate(3, "Greater Hall", "img/Greater Hall.png", 160, 140, [
        new Elements.Door(1, 80, 140),
        new Elements.Door(2, 80, 0)
    ]);

    var GrandHall = new Elements.RoomTemplate(4, "Grand Hall", "img/Grand Hall.png", 135, 135, [
        new Elements.Door(1, 68, 135),
    ...
    var GrandestHall = new Elements.RoomTemplate(4, "Grandest Hall", "img/Grandest Hall.png", 140, 140, [
        new Elements.Door(1, 70, 140),
    ...
    // Connectors
    var CrossJunction = new Elements.RoomTemplate(100, "Cross Junction", "img/Cross Junction.png", 70, 70, [
    ...
    var LConnector = new Elements.RoomTemplate(104, "L Connector", "img/L Connector.png", 40, 40, [
        new Elements.Door(1, 35, 40),
        new Elements.Door(2, 0, 5)
    ]);
    ...
    var ChemLab = BioLab.Copy(1002, "Chem Lab", "img/Chem Lab.png");
    var EnergyLab = BioLab.Copy(1003, "Energy Lab", "img/Energy Lab.png");
    var Oracle = BioLab.Copy(1004, "Oracle", "img/Oracle.png");
    var Reactor = new Elements.RoomTemplate(1005, "Reactor", "img/Reactor.png", 65, 60, [new Elements.Door(1, 30, 65)]);

    var Barracks = new Elements.RoomTemplate(1006, "Barracks", "img/Barracks.png", 55, 65, [new Elements.Door(1, 32, 55)]);
    var Garden = new Elements.RoomTemplate(1007, "Garden", "img/Garden.png", 70, 70, [
        new Elements.Door(1, 35, 70),
        new Elements.Door(2, 0, 35),
        new Elements.Door(3, 35, 0),
        new Elements.Door(4, 70, 35)
...
//# sourceMappingURL=RoomStats.js.map
