...
(function (RoomStats) {
    // Halls
    var ClanHall = new Elements.RoomTemplate(1, "img/Clan Hall.png", 140, 60, [
        new Elements.Door(1, 30, 140),
        new Elements.Door(2, 30, 0)
    ]);
    var GreatHall = ClanHall.Copy("img/Great Hall.png", 2);

    var GreaterHall = new Elements.RoomTemplate(3, "img/Greater Hall.png", 160, 140, [
        new Elements.Door(1, 80, 140),
        new Elements.Door(2, 80, 0)
    ]);

    var GrandHall = new Elements.RoomTemplate(4, "img/Grand Hall.png", 135, 135, [
    ...
    var GrandestHall = new Elements.RoomTemplate(4, "img/Grandest Hall.png", 140, 140, [
    ...
    var LConnector = new Elements.RoomTemplate(104, "img/L Connector.png", 40, 40, [
        new Elements.Door(1, 35, 40),
        new Elements.Door(2, 0, 5)
    ]);
    ...
    var Garden = new Elements.RoomTemplate(1007, "img/Garden.png", 70, 70, [
        new Elements.Door(1, 35, 70),
        new Elements.Door(2, 0, 35),
        new Elements.Door(3, 35, 0),
        new Elements.Door(4, 70, 35)
